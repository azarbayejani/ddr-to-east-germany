...
describe('Translator', function() {
	describe('#translate', function() {
		...
		it('should make Apple Watch be Galaxy Gear', function() {
			var t1 = {
				nodeValue: "WATCH"
			};
			var t2 = {
				nodeValue: "Apple Watch"
			};
			var expected = "Galaxy Gear";
			translator.translate(t1);
			translator.translate(t2);
			assert.equal(expected, t1.nodeValue);
			assert.equal(expected, t2.nodeValue);
		});
